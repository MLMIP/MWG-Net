...
class VGG(nn.Module):
    def __init__(self):
        ...
        conv5_1.add_module('relu5_3_1', nn.ReLU()) # 3 CONV
        ...
        self.conv5_2 = conv5_2 # 3 CONV

        pre_train = torch.load('/media/s3/th/covid-19-code/Model/vgg16-397923af.pth')
